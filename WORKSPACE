...
http_archive(
    ...
    strip_prefix = "googleapis-5f61cd5a991506c795a2b0a3639eb5e1b0cb6b27",
    urls = [
...
http_archive(
    ...
    sha256 = "37a3446b351b3982eb2ff14c3cfc1dda1743ca1670cc3ab42e2489767f23eadb",
    strip_prefix = "rules_distroless-0.9.5",
    url = "https://github.com/GoogleContainerTools/rules_distroless/releases/download/v0.9.5/rules_distroless-v0.9.5.tar.gz",
)
...
oci_pull(
    ...
    digest = "sha256:f324c7ff54321e8d9c588493a20244965938ce0aa50bbd1022d38010e9ffc4b1",  # bookworm as of 06/20/24
    image = "debian",
